...
const useState = (initialState) => {
  ...
  let stackStackPointer = stateStack[stackPointer] || initialState;

  const setter = (toSetValue) => {
      stackStackPointer =  (typeof toSetValue === 'function') ?
       toSetValue(stackStackPointer) : toSetValue;
    
  }
  return [stackStackPointer, setter]
  // [MODIFICATION ALLOWED]
}
